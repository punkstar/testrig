...
class Magento1510 extends Magento {
    ...
    public function getUrl() {
        return "http://www.magentocommerce.com/downloads/assets/1.5.1.0-rc1/magento-1.5.1.0-rc1.tar.gz";
    }
    ...
    public function getCommands() {
        ...
        return array(
            ...
            new \Meanbee\Testrig\Command\Fetch($this->getUrl(), $temporary_gz_file, 'Fetching Magento 1.5.1.0'),
