...
class Magento1620 extends Magento {
    public function getVersion() {
        return "1.6.2.0";
    }

    public function getUrl() {
        return "http://www.magentocommerce.com/downloads/assets/1.6.2.0/magento-1.6.2.0.tar.gz";
    }
    ...
    public function getCommands() {
        ...
        return array(
            ...
            new \Meanbee\Testrig\Command\Fetch($this->getUrl(), $temporary_gz_file, 'Fetching Magento 1.6.2.0'),
